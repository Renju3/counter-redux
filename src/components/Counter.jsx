...
function Counter() {
  ...
  // useSelector Hook is used to acess value  from store
  ...
  return (
    ...
    <div className='mt-3 w-100'>
      <input type="text" placeholder='Enter the range' 
      className='form-control border border-primary' onChange={(e)=>setRange(e.target.value)}/>
    </div>
    </>
  )
}
